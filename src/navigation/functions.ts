import { Layout, Navigation as RNNavigation, Options, NavigationFunctionComponent } from 'react-native-navigation'
...
export function setLayoutStackChildren<P>(props: NavigationProps<P>, options?: Options): Layout {
  return {
